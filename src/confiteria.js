...
import { crearComida, editarComida, eliminarComida, getComidas } from "../services/fetchConfiteria.js";
...
const getValoresDelFormulario = () => {
  const comidaNueva = {
    titulo: comidaTitulo.value,
    descripcion: comidaDescripcion.value,
    precio: comidaPrecio.value,
